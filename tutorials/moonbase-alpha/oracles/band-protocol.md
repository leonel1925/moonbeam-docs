...
# Using Band Protocol Oracle with Moonbeam
...
For example, using [Remix](/builders/tools/remix-ide/), we can easily query the `BTC/USD` price pair using this interface.
