...
MathWallet [announced](https://mathwallet.org/moonbeam-wallet/en/) that is now natively supporting the [Moonbase Alpha TestNet](/ecosystem/platform/networks/moonbase-alpha/). This means that you are now able to interact with Moonbase Alpha using another wallet besides MetaMask.
