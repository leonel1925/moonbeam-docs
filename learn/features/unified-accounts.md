...
The Polkadot JS Apps interface was updated as well so that it natively supports H160 addresses and ECDSA keys. You can check out [this tutorial](/tutorials/moonbase-alpha/wallets/polkadot-js-apps/) to see more about this integration.
